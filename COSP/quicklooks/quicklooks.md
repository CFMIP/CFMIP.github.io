...
All figures show monthly means for a single January of a model integration: HadGEM (top) and CAM/ACME (bottom). Users can contrast similar plots from one of their simulations to confirm that their outputs appear reasonable.
...
<p align="center"><img src="./clt_ga6.png" width="500"><img src="./FISCCP1_COSP-CLDTOT_map.png" width="500"></p>
